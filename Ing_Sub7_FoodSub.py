...
for page_number in range(89):
    ...
    for website in ingredient_urls:
        ...
        amount123 = {'quantity': 100, 'unit': 'gr'}

        # Add the "Source" field to the ingredient object
        source = "FoodSubs (https://foodsubs.com/groups)"
        ingredient_obj = {
            'Ingredient': main_ingredient,
            'Description': description,
            'Amount' : amount123,
            'Substitute': substitution_table,
...
with open('Ing_Sub7_FoodSub.json', 'w', encoding='utf-8') as file:
