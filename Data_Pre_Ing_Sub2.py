...
csv_file_path = 'C:\\Users\\hwkim\\OneDrive\\바탕 화면\\Ingredient_Substitution_AI\\KG_Food_Project_Revathy\\Ing_Sub2.csv'
json_file_path = 'C:\\Users\\hwkim\\OneDrive\\바탕 화면\\Ingredient_Substitution_AI\\KG_Food_Project_Revathy\\Ing_Sub2.json'
...
with open(csv_file_path, 'r') as csv_file:
    ...
    for row in csv_reader:
        ...
        source = "theSpruceEats (https://www.thespruceeats.com/ingredient-substitution-chart-3054056)"
        ...
        entry = {"Ingredient": ingredient, "Amount": amount_data, "Substitute": substitute_data, "Source": source}
        data.append(entry)
